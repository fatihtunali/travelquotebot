...
export default function CustomerRequestsPage() {
  ...
  const getStatusBadge = (quote: any) => {
    if (quote.status === 'accepted') {
      ...
      return <span className="px-3 py-1 bg-teal-100 text-teal-700 text-xs font-semibold rounded-full">Viewed</span>;
        ...
        {stats && (
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 mb-8">
            ...
            <div className="bg-white/70 backdrop-blur-xl rounded-xl shadow-lg border border-white/20 p-4">
              ...
              <p className="text-3xl font-bold text-teal-600 mt-1">{stats.viewed}</p>
            </div>
            <div className="bg-white/70 backdrop-blur-xl rounded-xl shadow-lg border border-white/20 p-4">
                            ...
                            <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-xl border border-gray-200 z-10">
                              ...
                              {quote.status !== 'accepted' && quote.status !== 'rejected' && quote.status !== 'expired' && (
                                <button
                                  ...
                                  className="w-full px-4 py-2 text-left text-sm text-teal-600 hover:bg-teal-50 flex items-center gap-2"
                                >
                                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={6}
                  className="w-full px-4 py-3 bg-white text-gray-900 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-200 placeholder:text-gray-400"
            ...
            <div className="p-6 border-t border-gray-200 flex justify-end gap-3">
              ...
              <button
                ...
                disabled={submitting}
                className="px-6 py-3 bg-gradient-to-r from-teal-600 to-cyan-600 text-white rounded-xl font-medium hover:from-teal-700 hover:to-cyan-700 transition-all duration-200 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
              >
